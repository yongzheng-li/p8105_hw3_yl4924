...
from the the summary result, the data contain 2595176 observations and 9 variables. The key variables are prcp, snow, snwd, tmax, and tmin. There are 145838, 381221, and 591786 missing values in variable prcp, snow and snwd that account 5.6%, 14.7%, 22.8% percent of values in each variable, respectively. 

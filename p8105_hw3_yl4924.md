...
variables include week, day_id, day, minute, activity_count, and
day_of_week. Among these variables, activity_count is the most important
...
``` r
accel_data %>% 
ggplot(aes(x = minute, y = activity_count, color = week)) +
  geom_line(alpha = 0.5)
```
